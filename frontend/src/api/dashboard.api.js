...
export const getMortalidad = () => api.get('/dashboard/mortalidad')
export const getOcupacion = () => api.get('/dashboard/ocupacion')
export const getActividad = () => api.get('/dashboard/actividad')
